...
| 11            | K-Means Clustering                       | Customer segmentation based on income and spending behaviour for marketing strategy                          | Done    |
| 12            | Association Rule Mining (Apriori)        | Market basket analysis for product bundling and cross-selling                                                | Done    |
| 13            | Artificial Neural Network (ANN)          | Image or pattern recognition — automating decision workflows                                                 | Done    |
| 14            | Model Evaluation & Hyperparameter Tuning | Optimize models to achieve maximum predictive performance with minimal cost                                  | Done    |
| 15            | Mini Project                             | Real-world ML deployment: predictive analytics, trend forecasting, or anomaly detection                      | Done    |
